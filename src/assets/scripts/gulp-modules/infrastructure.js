...
$('.js-infrastructure__list-btn').on('click', function (e) {
	...
	$('.js-infrastructure-nav-list').slideToggle(300, ()=>{
		...
		if ($(this).hasClass('active')) {
			...
			console.log($('.js-infrastructure-nav-list'));
			const height = $('.js-infrastructure-block.infrastructure-block-map').height();
			$($('.js-infrastructure-nav-list')[0]).css('height', height - $('.infrastructure__list-btn').height)
		}
	})
